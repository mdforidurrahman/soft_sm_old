...
<body>
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex flex-row justify-content-between">
                    <p class="text-muted">by: {{strtoupper($blog->User->name)}} | Posted on {{$blog->created_at->format('d M, Y')}}</p>
                    <p class="text-muted">Category: <span class="badge bg-secondary"><a href="/blog/category?cat={{$blog->BlogCategory->slug}}" class="nav-link">{{$blog->BlogCategory->name}}</a></span></p>
                </div>
                <hr>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                @if ($blog->photo)
                <img src="{{ asset('blogPhotos/' . $blog->photo)}}" class="mx-auto d-block mb-4 w-75 h-60" alt="Blog Image">
                @else
                <img src="https://cdn.dribbble.com/users/782052/screenshots/11219988/doctors_illustration__4x.jpg" class="mx-auto d-block mb-4 w-75 h-60" alt="Blog Image">
                @endif
                <p>{{$blog->desc}}</p>
            </div>
        </div>

        <!-- Blog Footer with Share and Like Buttons -->
        <div class="row mt-5">
            <div class="col-12">
                <hr>
                <div class="d-flex justify-content-between">
                    ...
                    <p class="text-muted mt-3">Category: <span class="badge bg-secondary"><a href="/blog/category?cat={{$blog->BlogCategory->slug}}" class="nav-link">{{$blog->BlogCategory->name}}</a></span></p>
                </div>
            </div>
        </div>
        <hr>
