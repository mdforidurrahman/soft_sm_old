...
<!-- Mirrored from themewagon.github.io/medcare/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2024 05:40:17 GMT -->
            ...
            <div class="container" style="max-width: 1170px;">
                ...
                <div class="float-right">
                    <ul class="list header_social">
                        <li><a href="#" style="text-decoration: none;"><i class="ti-facebook"></i></a></li>
                        <li><a href="#" style="text-decoration: none;"><i class="ti-twitter-alt"></i></a></li>
                        <li><a href="#" style="text-decoration: none;"><i class="ti-linkedin"></i></a></li>
                        <li><a href="#" style="text-decoration: none;"><i class="ti-skype"></i></a></li>
                        <li><a href="#" style="text-decoration: none;"><i class="ti-vimeo-alt"></i></a></li>
                    </ul> 
                </div>
            </div>  
        </div>  
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="./"><img src="{{asset('webasset/img/logo.png')}}" alt=""></a>
  ...
  .card-footer {
    ...
    <div class="container mt-2">
        ...
        <nav class="nav nav-pills mb-3 justify-content-center">
            <a class="btn btn-outline-primary rounded-pill mx-1" href="/blog">All</a>
            @foreach ($categories as $catgry )
            <a class="btn btn-outline-primary rounded-pill mx-1" href="/blog/category?cat={{$catgry->slug}}##">{{$catgry->name}}</a>
            @endforeach
        </nav>
        <hr>
        <!-- <div class="row"> -->
            <!-- Cards Column -->
            <!-- <div class="col-md-10"> -->
                <h3 class="text-center">{{$category->name??'All'}} Blogs</h3>
                <hr>
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div class="col">
                            <div class="card">
                                <a class="nav-link" href="/blog-view/{{$blog->slug}}">
                                    @if ($blog->photo)
                                    <img src="{{ asset('blogPhotos/' . $blog->photo)}}" class="card-img-top" alt="...">
                                    @else
                                    <img src="https://cdn.dribbble.com/users/782052/screenshots/11219988/doctors_illustration__4x.jpg" class="card-img-top" alt="...">
                                    @endif
                                    <div class="card-body d-flex justify-content-evenly">
                                        <h5 class="card-title">{{$blog->name}}</h5>
                                        
                                        <p class="card-text" style="word-wrap: break-word;"> {{$blog->short_desc}} </p>
                                    </div>
                                </a>
                                <div class="card-footer d-flex flex-row justify-content-between">
                                    <small class="text-muted"><i class="fas fa-calendar-alt"></i> {{$blog->created_at->format('d M, Y')}}</small>
                                    <a href="/blog/category?cat={{$blog->BlogCategory->slug}}" class="nav-link"><small class="text-muted"><i class="fa-solid fa-tag"></i> {{$blog->BlogCategory->name}}</small></a>
                                    <small class="text-muted"><i class="fa-solid fa-heart"></i> 38</small>
                                </div>
                            </div>
                    </div>
                    @endforeach
            ...
            <!-- <div class="col-md-2">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-action">Hair</a>
                    <a href="#" class="list-group-item list-group-item-action">Skin</a>
        ...
        @if ($blogs->hasPages())
            <nav aria-label="Page navigation example" class="mt-4">
                <ul class="pagination justify-content-center">
                    ...
                    @else
                        <li class="page-item"><a class="page-link" href="{{ $blogs->previousPageUrl() }}##" rel="prev">Prev</a></li>
                    @endif
                    ...
                    @if ($blogs->hasMorePages())
                        <li class="page-item"><a class="page-link" href="{{ $blogs->nextPageUrl() }}##" rel="next">Next</a></li>
                    @else
    ...
    <div class="container">
        ...
        <div class="row footer-bottom d-flex justify-content-between">
            <p class="col-lg-12 footer-text m-0 text-center">
                ...
                Copyright &copy; <script>document.write(new Date().getFullYear());</script> Daffodil International University. All rights reserved.
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
        </div>
    </div>
...
<!-- Mirrored from themewagon.github.io/medcare/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2024 05:40:24 GMT -->
</html>