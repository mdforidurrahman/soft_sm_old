...
{{-- 					<li> --}}
{{-- 						<a href="{{ route($role . '.contacts.index') }}"><i class="bx bx-address-book"></i> --}}
{{-- 							Contact List --}}
{{-- 						</a> --}}
{{-- 					</li> --}}
					@endpermission
                    ...
                    @permission('customer_view')
					<li>
						<a href="{{ url($role . '/customers/paid') }}"><i class="bx bx-user-pin"></i>
							Paid Customer List
						</a>
					</li>
					@endpermission
                    ...
                    @permission('customer_view')
					<li>
						<a href="{{ url($role . '/customers/cash') }}"><i class="bx bx-user-pin"></i>
							Cash Customer List
						</a>
					</li>
					@endpermission
                    ...
                    @permission('customer_view')
					<li>
						<a href="{{ url($role . '/customers/due') }}"><i class="bx bx-user-pin"></i>
							Due Customer List
						</a>
					</li>
					@endpermission
                    ...
                    @permission('customer_view')
					<li>
						<a href="{{ url($role . '/customers/overdue') }}"><i class="bx bx-user-pin"></i>
							Over due Customer List
						</a>
					</li>
					@endpermission
          ...
          @permission('accounts_view')
			<li>
				...
				<ul>
                   ...
                   @permission('accounts_transaction')
                             <li>
                                 <a href="{{ route('admin.account-transactions.transactions-summary') }}">
            ...
            @permission('repoting_view')
			<li>
				<a href="javascript:;" class="has-arrow">
					<div class="parent-icon"><i class="bx bx-user-circle"></i></div>
					<div class="menu-title">Repoting</div>
				</a>
				<ul>                  
                   @permission('repoting')
                             <li>
                                 <a href="{{ route('admin.repoting.index') }}">
                              <i class="bx bx-list-ul"></i>
                                 Sales Collection Repoting Overview
                               </a>
                             </li>
                  @endpermission
