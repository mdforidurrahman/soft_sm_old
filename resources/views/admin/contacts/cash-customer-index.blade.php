...
@section('title', 'Cash Customers List')
...
@section('content')
<x-breadcumb title="Cash Customers List" />
    ...
    <div class="dashboard-card">
        <div class="card-header-section">
            <div class="table-title-section">
                ...
                <h5 class="table-title">Cash Customers Overview</h5>
            </div>
...
<script>
    ...
    function loadTable() {
        ...
        initDataTable(
            '#example2',
            '{{ route($role . "customers.cash") }}', // Set your route here
            columns,
            {
                order: [[3, 'desc']],
