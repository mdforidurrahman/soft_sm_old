...
@section('title', 'Over Due Customers List')
...
@section('content')
<x-breadcumb title="Over Due Customers List" />
    ...
    <div class="dashboard-card">
        <div class="card-header-section">
            <div class="table-title-section">
                ...
                <h5 class="table-title">Over Due Customers Overview</h5>
            </div>
